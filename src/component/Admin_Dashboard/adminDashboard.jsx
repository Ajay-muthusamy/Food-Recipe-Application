...
import Graphlogo from '../../assets/d1 (1).jpg'
    ...
    <div>
      ...
      <main className="d-flex flex-nowrap">
        ...
        <div class="container text-center ">
          <div class="row ps-2">
            <div class="col-6 col-md-4 d-flex gap-3 m-5">
            <Webdetails count="150" desc="Total Recipes"/>
            <Webdetails count="12,000" desc="Total View"/>
            <Webdetails  count="10,000" desc="Upload"/>
            <Webdetails count = "50%" desc="Bounce Rate"/>
            
            </div>
          </div>
          
          <img src={Graphlogo} alt=""  style={{width:"70%"}}/>
          <Blogupdate />
          <Deleteblog />
